...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			...
			) AS cat_id, -- Removing category id of 1st five character from prd_key, also replacing - with _.
			...
			CAST(LEAD (prd_start_dt) OVER(PARTITION BY prd_key ORDER BY prd_key) - 1 AS DATE
	...
	BEGIN CATCH
		PRINT '================================================='
		PRINT 'ERROR_OCCURED During Loading the Silver layer'
